...
const CONFIG = {
  ...
  // Pagamento online pausado: aguardando o PagBank liberar a conta (allowlist).
  // Para religar, volte a URL: 'https://apetrechos-checkout.onrender.com'
  checkoutApi: '', // back-end no Render (frete por região + PagBank)
};
...
const PRODUCTS = [
  ...
  p('sp01', 'Sapatênis Pegada Levitech Branco', 'Pegada', 'sapatenis', 149.95, 329.95,
    ['branco'], [39, 40],
    { stock: 2, photos: ['assets/img/products/pegada-sapatenis-branco.jpg?v=2'],
  ...
  p('sp02', 'Sapatênis Pegada Pinhão', 'Pegada', 'sapatenis', 100.0, 209.95,
    ['pinhao'], [39],
    { stock: 2, photos: ['assets/img/products/pegada-sapatenis-pinhao.jpg?v=2'],
  ...
  p('sp03', 'Sapatênis Strike Gelo', 'Strike', 'sapatenis', 100.0, 210.0,
    ['gelo'], [38, 39, 40, 41],
    { stock: 4, photos: ['assets/img/products/strike-sapatenis-gelo.jpg?v=2'],
  ...
  p('h01', 'Sandália Vizzano Salto Alto Preta', 'Vizzano', 'saltos', 50.0, 129.95,
    ['preto'], [38],
    { stock: 1, heel: '10 cm', glyph: 'sandal', photos: ['assets/img/products/vizzano-salto-alto-preta.jpg?v=2'],
  ...
  p('h02', 'Sandália Vizzano Salto Alto Caramelo', 'Vizzano', 'saltos', 59.95, 199.95,
    ['caramelo'], [35, 38],
    { stock: 2, heel: '12 cm', glyph: 'sandal', photos: ['assets/img/products/vizzano-salto-alto-caramelo.jpg?v=2'],
  ...
  p('h03', 'Sandália Mariotta Salto Fino Grafite', 'Mariotta', 'saltos', 109.95, 189.95,
    ['grafite'], [36, 39],
    { stock: 2, heel: '9 cm', glyph: 'sandal', photos: ['assets/img/products/mariotta-salto-fino-grafite.jpg?v=2'],
  ...
  p('s01', 'Sandália Flatform Vizzano Preta', 'Vizzano', 'sandalias', 149.95, 209.95,
    ['preto'], [35, 36, 37, 39],
    { stock: 4, heel: '6 cm', glyph: 'sandal', photos: ['assets/img/products/vizzano-flatform-preta.jpg?v=2'],
  ...
  p('s02', 'Tamanco Vizzano Caramelo', 'Vizzano', 'sandalias', 64.95, 154.95,
    ['caramelo'], [34, 36, 39],
    { stock: 3, heel: '6 cm', glyph: 'sandal', photos: ['assets/img/products/vizzano-tamanco-caramelo.jpg?v=2'],
  ...
  p('r01', 'Rasteira Mississipi Branca', 'Mississipi', 'rasteiras', 59.95, 109.95,
    ['branco'], [35, 36, 37],
    { stock: 3, glyph: 'sandal', photos: ['assets/img/products/mississipi-rasteira-branca.jpg?v=2'],
  ...
  p('r02', 'Rasteira Mississipi Preta', 'Mississipi', 'rasteiras', 59.95, 129.95,
    ['preto'], [35, 36, 38],
    { stock: 3, glyph: 'sandal', photos: ['assets/img/products/mississipi-rasteira-preta.jpg?v=2'],
  ...
  // ---- Infantil ----------------------------------------------------------
  p('k01', 'Tênis Ollie Space 2 Infantil Preto', 'Ollie', 'infantil', 139.95, null,
    ['preto'], [31, 35],
    { stock: 2, photos: ['assets/img/products/ollie-space2-preto.jpg?v=2'],
      material: 'Sintético com solado leve',
      description: 'Tênis casual infantil preto com listras brancas e solado branco. Estilo esportivo para o dia a dia das crianças.' }),
  p('k02', 'Tênis Ollie Space 2 Infantil Branco', 'Ollie', 'infantil', 139.95, null,
    ['branco'], [30, 32, 36],
    { stock: 3, photos: ['assets/img/products/ollie-space2-branco.jpg?v=2'],
      material: 'Sintético com solado leve',
      description: 'Tênis casual infantil branco com listras e calcanhar pretos. Combina com o uniforme e com o look de passeio.' }),
  p('k03', 'Tênis Ollie Pro Max 3 Infantil Gelo', 'Ollie', 'infantil', 149.95, null,
    ['gelo'], [31, 32],
    { stock: 3, photos: ['assets/img/products/ollie-promax3-gelo.jpg?v=2'],
  ...
  p('k04', 'Sandália Sonic Infantil', 'Sonic', 'infantil', 99.95, 129.95,
    ['azul'], [29, 30, 32, 33],
    { stock: 3, glyph: 'sandal', photos: ['assets/img/products/sonic-sandalia-infantil.jpg?v=2'],
  ...
  p('k05', 'Tênis Box Kids Preto e Vermelho', 'Box 200', 'infantil', 50.0, null,
    ...
    { stock: 19, photos: ['assets/img/products/box-kids-preto-vermelho.jpg?v=2'],
      material: 'Cabedal têxtil com solado leve',
      description: 'Tênis esportivo infantil preto com solado e detalhes em vermelho. Leve e confortável para as crianças correrem o dia todo. Promoção: leve 2 pares por R$ 80.' }),
  p('k06', 'Tênis Box Kids Azul e Rosa', 'Box 200', 'infantil', 50.0, null,
    ['azulbb'], [29, 30, 33],
    { stock: 3, photos: ['assets/img/products/box-kids-azul-rosa.jpg?v=2'],
      material: 'Cabedal têxtil com solado leve',
